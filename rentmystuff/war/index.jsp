	...
	<div class="bg">
		<div class="main">
			<header>
				<div class="row-1">
					<h1>
						<a class="logo" href="index.jsp">Rent.My.Stuff</a>
						<strong class="slog">Peer-to-Peer Sharing Portal</strong>
					</h1>
						...
						<div class="slider">
						  <ul class="items">
							<li><img src="images/slider-img1.jpg" alt="">
								<strong class="banner">
									<strong class="b1">pool your</strong>
									<strong class="b2">rides & cabs</strong>
									<!-- <strong class="b3">Remember there's mother<br> nature to be saved.</strong> -->
								</strong>
							</li>
							<li><img src="images/slider-img2.jpg" alt="">
								<strong class="banner">
									<strong class="b1">lend or borrow</strong>
									<strong class="b2">books</strong>									
								</strong>
							</li>
							<li><img src="images/slider-img3.jpg" alt="">
								<strong class="banner">
									<strong class="b1">share your</strong>
									<strong class="b2">gadgets & electronics</strong>									
								</strong>
							</li>
							<li><img src="images/slider-img4.jpg" alt="">
								<strong class="banner">
									<strong class="b1">rent out</strong>
									<strong class="b2">any item or capacity</strong>									
								</strong>
							</li>
						  </ul>
								...
								<div class="box third">
									<div class="pad">
										...
										<div class="wrapper">
											<a class="button img-indent-r" href="#">>></a>
											<div class="extra-wrap">
												It has several pages: <a class="link" href="index.jsp">Home</a>, <a class="link" href="news.jsp">News</a>, <a class="link" href="services.html">Services</a>, <a class="link" href="products.html">Products</a>, <a class="link" href="contacts.html">Contacts</a>.
											</div>
										</div>
									</div>
								</div>
