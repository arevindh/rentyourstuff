				...
				<div class="padding">
					<div class="wrapper p4">
						<div class="col-3">
							<div id="bookContent">
								<div class="col-1">
									<span style="font-size: 20px">Please login with Facebook to view all books available for you.</span>
								</div>
							</div>
							<div class="col-4">
									...
									<div>
										<div>
											...
											<div style="float: right">
												<a href="#"
													onclick="$('#bookContent').load('content/list_books.jsp', function() {
											$('.datetimepicker').timepicker();
											});  
											return false;"><h3
								...
								<div>
									<div>
										...
										<div style="float: right">
											<a href="#"
												onclick="$('#bookContent').load('content/books_search.jsp', function() {
											$('.datetimepicker').timepicker();
											});  
											return false;"><h3
													style="float: left; padding-top: 10%;">Find Books</h3> </a>
										</div>
									</div>
								</div>
